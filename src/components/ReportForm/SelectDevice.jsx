      ...
      >
        {devices.length > 0 ? (
          ...
          <div role="status" className="max-w-sm animate-pulse">
            ...
            <div className="mb-2.5 h-2.5 max-w-[360px] rounded-full bg-gray-200 " />
            <div className="mb-2.5 h-2.5 rounded-full bg-gray-200 " />
            <div className="mb-2.5 h-2.5 max-w-[330px] rounded-full bg-gray-200 " />
            <div className="mb-2.5 h-2.5 max-w-[300px] rounded-full bg-gray-200 " />
            <div className="h-2.5 max-w-[360px] rounded-full bg-gray-200 " />
